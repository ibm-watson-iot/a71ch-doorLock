...
var settings = {
    ...
    // The default iotadmin password is testPassw0rd
    // To change password use "node-red-admin hash-pw" command and update 
    // value of the password below.
    adminAuth: {
        type: "credentials",
        users: [{
            username: "iotadmin",
            password: "$2a$08$hsKVpIjalWk9A8zw5Pks8erDDHKTzqwRMusK/gQcvDmFqsMgXtuR2",
            permissions: "*"
        }]
    },
